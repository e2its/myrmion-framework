...
| `transparencyRef` | C | URI/docId | [Ficha de transparencia](../../templates/compliance/ficha-transparencia-ia.md) del agente. **Requerido si el agente interactúa con personas o genera contenido**, y siempre en alto riesgo. |
