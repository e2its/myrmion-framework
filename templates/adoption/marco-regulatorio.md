...
- *El **rol** importa tanto como la clase: la organización es típicamente deployer, pero poner el nombre propio sobre un sistema o modificarlo sustancialmente la convierte en proveedor (art. 25), sujeto a las obligaciones del art. 16 — desde los requisitos de los arts. 9–15 hasta el QMS (art. 17), la conservación de documentación y logs (arts. 18–19), la evaluación de conformidad (art. 43), el marcado CE (art. 48) y el registro UE (art. 49). La decisión de rol se toma aquí, con criterio jurídico.*
